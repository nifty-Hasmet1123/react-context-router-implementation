...
function RQPage() {
  ...
  // if your not planning to wrap the whole main with Queryclient provider then 
  ...
  return (  
    <>
      <h2>RQ JSON Placeholder</h2>
      <p>Name: { data?.name }</p>
    </>
  );
}

// use a wrapper function to wrap the entire code with the clien provider won't work if you put it in the same function
